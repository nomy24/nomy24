  ...
  "plans": [
    {
      ...
      "features": ["主な機能"],
      "design": {
        "mock": "list / board / queue / detail / gallery / calendar / checklist / form / dashboard / streak のどれか",
        "pattern": "画面の型",
        "layout": "情報の並べ方",
...
このメモをもとに、アプリ案を3つ立ててください。**3つは「同じアプリの大・中・小」であってはいけません。**
目的そのものが違う、別々の切り口にしてください。たとえば次のように、狙う場面と主役の画面が異なるものを選びます。

- 早く書き留めることに賭ける／あとで見つけることに賭ける／人と回すことに賭ける
- 写真や場所を主役にする／日付と当番を主役にする／数と傾向を主役にする
- 同じ質問に二度答えない／同じことを二度書かない／機械に下ごしらえをさせる

3案それぞれに axisLabel（その切り口を一言で表す言葉）を付け、design.mock には主役の画面に合う型を選びます。
3案で design.mock が重ならないようにしてください。

書き方の決まり:
- メモに実際に出てきた言葉を使うこと。一般論だけの案は書かない。
- デザイン案は、配色（実際の16進数）、画面の並び、操作の核まで具体的に書く。3案で配色も変える。
- ${harsh
